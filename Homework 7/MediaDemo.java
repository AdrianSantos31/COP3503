...
public class MediaDemo extends Application {
  private static final String MEDIA_URL =
    "http://www.unf.edu/~n00798593/CoolResources/pingpong.mp4";
  ...
  public void start(Stage primaryStage) {
    ...
    ImageView playButton = new ImageView(String http://www.unf.edu/~n00798593/CoolResources/play.png);
    Button playButton = new Button(">");
    playButton.setOnAction(e -> {
      if (playButton.getGraphic().equals(">")) {
        mediaPlayer.play();
        playButton.setText("||");
      } else {
        mediaPlayer.pause();
